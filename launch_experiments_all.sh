...
# python experiments.py -p $pickle_folder -e create_video_captions -s 0 -l 7010 -v true -sp $solr_sensembed_path -jp $path_to_train_val_videodatainfo
# python experiments.py -p $pickle_folder -e compute_similarities -s 0 -l 7010 -v true -sp $solr_sensembed_path -jp $path_to_train_val_videodatainfo
...
python experiments.py -p $pickle_folder -e experiment3 -s 3000 -l 3010 -v true -sp $solr_sensembed_path -jp $path_to_train_val_videodatainfo > results/experiment3/experiment3_small.txt
